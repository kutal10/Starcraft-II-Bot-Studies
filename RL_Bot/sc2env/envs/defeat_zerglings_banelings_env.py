...
class DZBEnv(gym.Env):
    ...
    def step(self, action):
        raw_obs = self.take_action(action) #take a safe action
        reward = raw_obs.reward #acquire a reward from said action
        obs = self.get_derived_obs(raw_obs) #accumulate the derived observ
